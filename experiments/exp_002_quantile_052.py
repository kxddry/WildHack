"""exp_002: LightGBM quantile regression alpha=0.52 (shift predictions up)."""
import sys
import time
...
def main():
    print("=" * 60)
    print(f"EXP_002: Quantile regression alpha={ALPHA}")
    print("=" * 60)
    ...
    print(f"RESULT: exp_002 | CV={score:.6f} | model=LGB_quantile_{ALPHA} | train_days=7")
